...
parcelRequire = (function (modules, cache, entry, globalName) {
  ...
  return newRequire;
})({"section-detection.js":[function(require,module,exports) {
...
if (sidebarMenu) {
  (function () {
    ...
    var activateMenuItem = function activateMenuItem() {
      var idToActivate = elementWithPriority();
      var currentActiveItem = document.querySelector('.sidebar-menu li a.active');
      ...
      if (idToActivate) {
        var itemToActivate = document.querySelector('[data-section="' + idToActivate.element.id + '"]');
